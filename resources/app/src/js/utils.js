...
export async function addConstraints() {
    ...
    await session
        ...
        .catch((_) => {});
    await session.run('CREATE INDEX ON :AzApplication(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzApplication(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevice(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevice(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzGroup(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzGroup(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzKeyVault(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzKeyVault(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzResourceGroup(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzResourceGroup(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzServicePrincipal(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzServicePrincipal(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzTenant(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzTenant(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzUser(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzUser(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzVm(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzVm(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzRoleGroup(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzRoleGroup(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzRoleGroup(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzRoleGroup(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsOrg(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsOrg(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsPrj(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsPrj(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsUser(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsUser(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsGroup(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzDevOpsGroup(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzAdRole(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzAdRole(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzArmRole(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzArmRole(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzMgmtGroup(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzMgmtGroup(name)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzSubscription(objectid)').catch((_) => {});
    await session.run('CREATE INDEX ON :AzSubscription(name)').catch((_) => {});
