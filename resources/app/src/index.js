...
global.appStore = {
    ...
    highResPalette: {
        ...
        edgeScheme: {
            ...
            CanPSRemote: 'tapered',
            AssignedTo: 'tapered', // Azure
            DirectoryReadWriteAll: 'tapered', // Azure
            AppRoleAssignmentReadWriteAll: 'tapered', // Azure
            RoleManagementReadWriteDirectory: 'tapered', // Azure
            RunsAs: 'tapered', // Azure
            EligibleTo: 'tapered', // Azure
            ScopedTo: 'tapered', // Azure
        },
    },
    lowResPalette: {
        colorScheme: {
            ...
            GPO: '#7F72FD',
            AzPrivGroup: '#34D2EB',
            AzCloudAppRole: '#34D2EB',
            AzDevice: '#34D2EB',
            AzUser: '#34D2EB',
            AzApplication: '#34D2EB',
            AzAdRole: '#34D2EB',
            AzTenant: '#34D2EB',
            AzVm: '#34D2EB',
            AzServicePrincipal: '#34D2EB',
            AzArmRole: '#34D2EB',
            AzMgmtGroup: '#34D2EB',
            AzSubscription: '#34D2EB',
            AzResourceGroup: '#34D2EB',
            AzKeyVault: '#34D2EB',
            Unknown: '#E6E600',
        },
        edgeScheme: {
            ...
            HasSIDHistory: 'line',
            CanPSRemote: 'line',
            AssignedTo: 'line', // Azure
            DirectoryReadWriteAll: 'line', // Azure
            AppRoleAssignmentReadWriteAll: 'line', // Azure
            RoleManagementReadWriteDirectory: 'line', // Azure
            RunsAs: 'line', // Azure
            EligibleTo: 'line', // Azure
            ScopedTo: 'line', // Azure
        },
    },
    highResStyle: {
...
if (typeof conf.get('edgeincluded') === 'undefined') {
    conf.set('edgeincluded', {
        ...
        HasSIDHistory: true,
        CanPSRemote: true,
        AssignedTo: true, // Azure
        DirectoryReadWriteAll: true, // Azure
        AppRoleAssignmentReadWriteAll: true, // Azure
        RoleManagementReadWriteDirectory: true, // Azure
        RunsAs: true, // Azure
        EligibleTo: true, // Azure
        ScopedTo: true, // Azure
    });
}
